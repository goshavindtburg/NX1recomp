...
const char* AccessViolationOperationName(arch::Exception::AccessViolationOperation op) {
  switch (op) {
    case arch::Exception::AccessViolationOperation::kRead:
      return "read";
    case arch::Exception::AccessViolationOperation::kWrite:
      return "write";
    default:
      return "unknown";
  }
...
void XThread::Execute() {
  ...
  REXSYS_DEBUG("XThread::Execute - Calling function at {:08X} (r1={:016X}, r3={:016X}, "
  ...
  REXSYS_INFO("XThread::Execute - Function {:08X} returned r3={:08X} lr={:08X}; exiting thid {}",
              address, ctx->r3.u32, ctx->lr, thread_id_);
