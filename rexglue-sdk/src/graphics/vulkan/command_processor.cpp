...
bool VulkanCommandProcessor::ExecutePacketType3_EVENT_WRITE_ZPD(memory::RingBuffer* reader,
  ...
  auto write_fallback_result = [this, sample_counts, sample_count_addr]() -> bool {
    ...
    WriteGuestOcclusionResult(sample_count_addr, occlusion_sample_accumulator_);
    return true;
  };
...
bool VulkanCommandProcessor::EndGuestOcclusionQuery(uint32_t sample_count_address) {
  ...
  WriteGuestOcclusionResult(sample_count_address, occlusion_sample_accumulator_);
  return true;
}
