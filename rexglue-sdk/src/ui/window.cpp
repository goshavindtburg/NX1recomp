...
REXCVAR_DEFINE_BOOL(fullscreen, false, "UI/Window", "Toggle fullscreen mode")
...
void Window::OnRawMouseMove(RawMouseEvent& e, WindowDestructionReceiver& destruction_receiver) {
  PropagateEventThroughInputListeners(
      [&e](auto listener) {
