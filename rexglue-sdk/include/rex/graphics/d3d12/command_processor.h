...
class D3D12CommandProcessor : public CommandProcessor {
 public:
  ...
  ID3D12RootSignature* GetNx1NativeRootSignature() const {
    return root_signature_nx1_native_shader_;
  }
 ...
 private:
  ...
  enum class Nx1NativeRootParameter : UINT {
    kVertexConstants,
    kPixelConstants,
    kSharedConstants,
    kFetchConstants,
  ...
  bool UpdateNx1NativeBindings(const D3D12Shader* vertex_shader,
                               const D3D12Shader* pixel_shader);
  bool SetNx1NativeVertexBuffers(const D3D12Shader* vertex_shader);
  ...
  uint32_t primary_buffers_since_submission_ = 0;
  ...
  ID3D12RootSignature* root_signature_nx1_native_shader_ = nullptr;
  ...
  enum class NativePresentRootParameter : UINT {
    kConstants,
    kDestination,
    kSource,
  ...
  Microsoft::WRL::ComPtr<ID3D12RootSignature> native_present_root_signature_;
  Microsoft::WRL::ComPtr<ID3D12PipelineState> nx1_native_present_copy_pipeline_;
  std::unique_ptr<ui::d3d12::D3D12DescriptorHeapPool> native_present_view_heap_pool_;
  ...
  uint64_t occlusion_sample_accumulator_ = 0;
  ...
  ConstantBufferBinding cbuffer_binding_nx1_native_vertex_constants_;
  ConstantBufferBinding cbuffer_binding_nx1_native_pixel_constants_;
  ConstantBufferBinding cbuffer_binding_nx1_native_shared_constants_;
  ConstantBufferBinding cbuffer_binding_nx1_native_fetch_constants_;
