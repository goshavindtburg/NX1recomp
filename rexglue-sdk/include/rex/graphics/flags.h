...
REXCVAR_DECLARE(uint32_t, d3d12_primary_buffer_submit_interval);
...
REXCVAR_DECLARE(bool, nx1_native_shader_cache);
REXCVAR_DECLARE(bool, nx1_native_shader_cache_vs_only);
REXCVAR_DECLARE(bool, nx1_native_shader_cache_color);
REXCVAR_DECLARE(bool, nx1_native_shader_cache_log);
// Legacy backend compatibility aliases for shared readback controls.
